    ...
    while true do
        ...
        if not mark[obj] then
            ...
            if m.isInRange(obj, offset) then
                if m.isContain(obj, offset) then -- what the user has selected basically
                    -- should only be one result most of the time
...
---@param obj parser.guide.object
---@return parser.guide.object
-- used for completion of :Methods and .Functions
-- just the name part? or the arg part as well im not sure
